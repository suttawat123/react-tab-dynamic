...
class Tab extends React.Component {
  ...
  handleNextPage = (currentPageId, payload) => {
    ...
    const currentPageIndex = this.state.tabList.findIndex(tab => tab.id === currentPageId)
  ...
  renderPageContainer = () => {
    ...
    const handleNextPageWithPageID = (payload) => { this.handleNextPage(setCurrentPage, payload) }
